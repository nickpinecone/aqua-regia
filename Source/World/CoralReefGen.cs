...
{
    // 3. These lines setup the localization for the message shown during world generation. Update your localization
    // files after building and reloading the mod to provide values for this.
    ...
    {
        // 5. We use FindIndex to locate the index of the vanilla world generation task called "Shinies". This
        // ensures our code runs at the correct step.
        int OceanCavesIndex = tasks.FindIndex(genpass => genpass.Name.Equals("Create Ocean Caves"));

        if (OceanCavesIndex != -1)
        {
            // 6. We register our world generation pass by passing in an instance of our custom GenPass class below.
            // The GenPass class will execute our world generation code.
